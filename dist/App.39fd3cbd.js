...
var check = function check() {
  // console.log("checked");
  document.getElementById("center_left").innerHTML = _create_or_join.default;
};

exports.check = check;
},{"../../views/create_or_join.html":"views/create_or_join.html"}],"Js/App.js":[function(require,module,exports) {
"use strict";
...
function login_load() {
  document.getElementById("center_left").innerHTML = _loginPage.default;
  document.getElementById("btn").addEventListener("click", _login_check.check);
}

document.onload = login_load();
},{"./Model/login_check":"Js/Model/login_check.js","../views/loginPage.html":"views/loginPage.html"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
